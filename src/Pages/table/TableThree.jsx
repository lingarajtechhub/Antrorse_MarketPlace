const TableThree = ({ activeComponent }) => {
  ...
  return (
    <div className="rounded-sm border border-gray-200 bg-white px-5 pt-6 pb-2.5 shadow-lg dark:border-slate-800 dark:bg-slate-800 sm:px-7.5 xl:pb-1">
      <div className="max-w-full overflow-x-auto">
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-[#F7F9FC] text-left text-lg font-bold dark:bg-gray-800">
              ...
              <th className="min-w-[120px] py-4 px-4 font-medium text-black dark:text-white">
                {activeComponent === "seller" ? "Status" : "Status"}
              </th>
              <th className="py-4 px-4 font-medium text-black dark:text-white">
                {activeComponent === "seller" ? "Actions" : "Actions"}
              </th>
            </tr>
          </thead>
          <tbody>
