...
const Calendar = () => {
  return (
    <div className="w-full max-w-full rounded-sm border border-gray-200 bg-white shadow-default dark:border-slate-800  dark:bg-gray-800">
      <table className="w-full">
        <thead>
          <tr className="grid grid-cols-7 rounded-t-sm bg-blue-600 text-white">
        ...
        <tbody>
          ...
          <tr className="grid grid-cols-7">
            <td className="ease relative h-20 cursor-pointer border border-gray-200 p-2 transition duration-500 hover:bg-blue-50 dark:border-slate-800  dark:hover:bg-gray-800 md:h-[6.25rem] md:p-6 xl:h-[7.75rem] ">
              <span className="font-medium text-black dark:text-white">1</span>
              <div className="group h-16 w-full flex-grow cursor-pointer py-1 md:h-30">
                <span className="group-hover:text-blue-600 md:hidden">
                  More
                </span>
                <div className="event invisible absolute left-2 z-99 mb-1 flex w-[200%] flex-col rounded-sm border-l-[3px] border-blue-600 bg-blue-50 px-3 py-1 text-left opacity-0 group-hover:visible group-hover:opacity-100 dark:bg-gray-800 md:visible md:w-[190%] md:opacity-100">
          ...
          <tr className="grid grid-cols-7">
            ...
            <td className="ease relative h-20 cursor-pointer border border-gray-200 p-2 transition duration-500 hover:bg-blue-50 dark:border-slate-800  dark:hover:bg-gray-800 md:h-[6.25rem] md:p-6 xl:h-[7.75rem] ">
              ...
              <div className="group h-16 w-full flex-grow cursor-pointer py-1 md:h-30">
                ...
                <div className="event invisible absolute left-2 z-99 mb-1 flex w-[300%] flex-col rounded-sm border-l-[3px] border-blue-600 bg-blue-50 px-3 py-1 text-left opacity-0 group-hover:visible group-hover:opacity-100 dark:bg-gray-800 md:visible md:w-[290%] md:opacity-100">
                  <span className="event-name text-sm font-semibold text-black dark:text-white">
                    App Design
                  </span>
                  <span className="time text-sm font-medium text-black dark:text-white">
