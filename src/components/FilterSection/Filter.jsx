                                  ...
                                  {section.options.map((option, optionIdx) => (
                                    ...
                                    >
                                      <input
                                        ...
                                        className="h-4 w-4 rounded-full border-gray-300 text-pink-600 focus:ring-pink-500"
                                      />
                                      <label
